    ...
    const fetchDashboardData = async () => {
        try {
            const [patientsRes, statsRes] = await Promise.all([
                ...
                axios.get('/api/doctor/dashboard/stats')
            ]);
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2">
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <Link to="/doctor/patients" className="text-xs font-bold text-violet-400 hover:text-violet-300 uppercase tracking-widest transition-colors">
                                    View All →
                                </Link>
                            </div>
                            ...
                            <div className="space-y-3">
                                {patients.length === 0 ? (
                                    ...
                                    patients.slice(0, 5).map(p => (
                                        <Link to={`/doctor/patients/${p._id}`} key={p._id} className="card border-subtle p-4 flex items-center justify-between hover:border-violet-500/20 hover:bg-white/[0.02] transition-all group">
                                            <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="card border-subtle overflow-hidden">
                                <div className="gradient-primary p-5 relative overflow-hidden">
                                    ...
                                    <Link to="/doctor/analytics" className="mt-4 inline-flex items-center gap-1.5 bg-white/15 text-white text-xs font-bold px-4 py-2 rounded-lg hover:bg-white/25 transition-all relative z-10 border border-white/20">
