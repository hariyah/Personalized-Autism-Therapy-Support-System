                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                            ...
                            <div className="flex flex-wrap gap-3">
                                <button onClick={() => navigate(`${BASE}/parent/children/${id}?tab=care-plan`)} className="btn-primary flex items-center gap-2">
                                    <FiShield /> Care Plan
                                </button>
                                <button onClick={() => navigate(`${BASE}/parent/therapy/${id}`)} className="btn-secondary flex items-center gap-2 border-teal-500/30 text-teal-300 hover:bg-teal-500/10">
                                    <FiActivity /> Therapy Activities
                                </button>
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                ...
                                <div>
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <button onClick={() => setActiveTab('analyses')} className="text-[10px] font-bold text-violet-400 hover:text-violet-300 uppercase tracking-widest transition-colors">View All Directory â†’</button>
                                    </div>
