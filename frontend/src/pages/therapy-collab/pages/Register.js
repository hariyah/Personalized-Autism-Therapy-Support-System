...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (user.role === 'doctor') navigate(`${BASE}/doctor/dashboard`);
            else navigate(`${BASE}/parent/dashboard`);
        } catch (err) {
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="text" required value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className="input-dark !pl-11" placeholder="Your full name" />
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="email" required value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} className="input-dark !pl-11" placeholder="you@example.com" />
                            </div>
                        </div>
                        <div>
