                        ...
                        <div className="divide-y divide-white/[0.05]">
                            {filteredPatients.length === 0 ? (
                                ...
                                filteredPatients.map(p => (
                                    <Link to={`/doctor/patients/${p._id}`} key={p._id} className="flex items-center justify-between p-6 hover:bg-white/[0.03] hover:border-violet-500/20 transition-all group">
