          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center">
              ...
              <p className="mt-3 text-xs text-gray-500">
                For therapy-collab accounts, use{' '}
                <Link to="/therapy-collab/register" className="font-medium text-pastel-green-600 hover:text-pastel-green-700 transition-colors">
                  /therapy-collab/register
                </Link>
                .
              </p>
            </div>
