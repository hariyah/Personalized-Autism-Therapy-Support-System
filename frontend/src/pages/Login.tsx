          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center">
              ...
              <p className="mt-3 text-xs text-gray-500">
                For the integrated therapy module, use{' '}
                <Link to="/therapy-collab/login" className="font-medium text-pastel-green-600 hover:text-pastel-green-700 transition-colors">
                  /therapy-collab/login
                </Link>
                .
              </p>
            </div>
